...
class SecureStorageService {
  ...
  static const String _serviceTokenKey = 'service_token';
  static const String _spaceSlugKey = 'space_slug';
  static const String _memoryScopeExternalRefKey = 'memory_scope_external_ref';
  ...
  Future<void> saveBackendPort(String port) => _set(_backendPortKey, port);
  Future<String?> getBackendPort() => _get(_backendPortKey);

  Future<void> saveServiceToken(String token) => _set(_serviceTokenKey, token);
  Future<String?> getServiceToken() => _get(_serviceTokenKey);

  Future<void> saveSpaceSlug(String slug) => _set(_spaceSlugKey, slug);
  Future<String?> getSpaceSlug() => _get(_spaceSlugKey);

  Future<void> saveMemoryScopeExternalRef(String ref) =>
      _set(_memoryScopeExternalRefKey, ref);
  Future<String?> getMemoryScopeExternalRef() =>
      _get(_memoryScopeExternalRefKey);
