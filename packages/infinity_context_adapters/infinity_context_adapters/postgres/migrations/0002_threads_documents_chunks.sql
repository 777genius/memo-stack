CREATE TABLE IF NOT EXISTS memory_threads (
    ...
    CONSTRAINT uq_thread_external_ref UNIQUE (space_id, memory_scope_id, external_ref)
);

CREATE INDEX IF NOT EXISTS ix_memory_threads_scope_status
    ON memory_threads (space_id, memory_scope_id, status);
...
CREATE TABLE IF NOT EXISTS memory_episodes (
    ...
    CONSTRAINT uq_episode_source UNIQUE (space_id, memory_scope_id, thread_id, source_external_id)
);
...
CREATE TABLE IF NOT EXISTS memory_chunks (
    ...
    updated_at TIMESTAMPTZ NOT NULL,
    metadata_json JSONB NOT NULL,
    CONSTRAINT uq_chunk_source_hash UNIQUE (space_id, memory_scope_id, source_hash),
...
CREATE INDEX IF NOT EXISTS ix_memory_chunks_scope_status
    ON memory_chunks (space_id, memory_scope_id, status);
