"""High-level MCP setup flows for Infinity Context integrations."""
...
from infinity_context_mcp.domain.models import McpDiagnostics, McpToolError, safe_message
...
class ObsidianPrepareMcpService:
    ...
    async def prepare(
        ...
        *,
        ...
        if not apply:
            return self._ok(
                "Infinity Context Obsidian prepare planned.",
                data={
        ...
        if not _api_ready(local_status):
            return self._ok(
                "Infinity Context Obsidian prepared. Backend is not ready yet.",
                data={
                    ...
                    "next_actions": [
                        "Start local Infinity Context runtime explicitly when ready.",
        ...
        return self._ok(
            "Infinity Context Obsidian prepared and preview checked.",
            data={
        ...
        **data: Any,
        ...
        return {
            ...
            "error": McpToolError(
                ...
                code=str(error.get("code") or "infinity_context_mcp.prepare.error"),
                message=public_message,
