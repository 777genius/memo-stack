...
from infinity_context_mcp.application.normalization import drop_none_values as _drop_none_values
            ...
            response = McpToolResponse(
                ...
                diagnostics=McpDiagnostics(
                    ...
                    degraded=code.startswith(
                        ("infinity_context_mcp.gateway.", "infinity_context_mcp.degraded.")
                    ),
                ),
            )
