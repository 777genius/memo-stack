"""Configuration for the Infinity Context MCP adapter."""
...
class MemoryMcpSettings:
    ...
    obsidian_root_folder: str = "Infinity Context"
...
def load_settings(env: Mapping[str, str] | None = None) -> MemoryMcpSettings:
    ...
    return MemoryMcpSettings(
        ...
        obsidian_root_folder=_get(values, "MEMORY_MCP_OBSIDIAN_ROOT_FOLDER", "Infinity Context"),
