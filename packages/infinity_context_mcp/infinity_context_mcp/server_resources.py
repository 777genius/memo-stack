...
def register_memory_resources_and_prompts(
    ...
    @mcp.resource(
        ...
        name="Memory Status",
        title="Memory Status",
        description="Read-only Infinity Context status and readiness.",
    ...
    def memory_pre_task_context(
        ...
        return (
            "Fetch relevant Infinity Context context before working.\n"
    ...
    def memory_document_ingest_policy(
        ...
        return (
            "Decide whether to ingest a document into Infinity Context.\n"
