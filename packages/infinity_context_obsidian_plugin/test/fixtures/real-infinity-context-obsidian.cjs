...
const python = process.env.INFINITY_CONTEXT_E2E_PYTHON || path.join(repoRoot, ".venv/bin/python");
...
delayFromEnv("INFINITY_CONTEXT_REAL_OBSIDIAN_DELAY_MS");

const result = spawnSync(python, ["-m", "infinity_context_obsidian.cli", ...args], {
  cwd: repoRoot,
  env,
  encoding: "utf8",
  maxBuffer: 1024 * 1024,
