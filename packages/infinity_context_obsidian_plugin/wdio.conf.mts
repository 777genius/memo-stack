...
const fakeCliPath = path.resolve(rootDir, "test/fixtures/fake-infinity-context-obsidian.cjs");
const realCliPath = path.resolve(rootDir, "test/fixtures/real-infinity-context-obsidian.cjs");
...
const localBinaryPath = process.env.INFINITY_CONTEXT_OBSIDIAN_BINARY_PATH ?? defaultMacBinaryPath;
const localAppPath = process.env.INFINITY_CONTEXT_OBSIDIAN_APP_PATH ?? defaultMacAppPath;
...
const localObsidianVersion = hasLocalObsidian
  ? process.env.INFINITY_CONTEXT_OBSIDIAN_VERSION ?? readMacAppVersion(defaultMacObsidianApp)
  : undefined;
