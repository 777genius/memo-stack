...
from infinity_context_server.eval_common import _seed_eval_deleted_fact, _seed_eval_updated_fact
...
def _long_memory_document_text() -> str:
    ...
    return (
        "LONGMEM_DOC_PROJECT_SCOPE: Infinity Context is shared project memory for coding "
