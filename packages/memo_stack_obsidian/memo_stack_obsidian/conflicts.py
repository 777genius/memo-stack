...
from memo_stack_obsidian.domain import ExportChange, ExportStatus, ImportChange, ImportStatus
from memo_stack_obsidian.frontmatter import dump_frontmatter
from memo_stack_obsidian.layout import DEFAULT_ROOT_FOLDER, ObsidianVaultLayout, safe_filename
from memo_stack_obsidian.ports import VaultPort
...
def render_conflict_artifact(
    *,
    ...
    metadata = {
        "memo_stack_conflict": True,
        "memo_stack_conflict_direction": direction,
        "memo_stack_source_path": change.path.as_posix(),
        "memo_stack_fact_id": change.fact_id or "",
        "memo_stack_version": change.version or "",
    }
    return (
        dump_frontmatter(metadata)
        + "\n".join(
            [
                "# Memo Stack Sync Conflict",
                "",
                ...
                "## What to do",
                "",
                "Review the source note and Memo Stack fact before applying changes.",
