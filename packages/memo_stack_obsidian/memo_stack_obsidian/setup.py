...
from memo_stack_obsidian.conflicts import CONFLICTS_DIR
...
from memo_stack_obsidian.sync import INBOX_DIR
    ...
    *,
    ...
    return "\n".join(
        [
            "# Memo Stack",
            "",
            "This folder is managed by the Memo Stack Obsidian connector.",
            "",
            "## Scope",
            "",
            f"- Space: `{space_slug}`",
...
def _inbox_readme() -> str:
    return "\n".join(
        [
            "# Memo Stack Inbox",
            "",
            "Write free-form notes here when you want Memo Stack to create pending suggestions.",
            "",
...
def _generated_keep_readme() -> str:
    return "\n".join(
        [
            "# Generated Facts",
            "",
            "Memo Stack writes managed fact notes into this folder.",
            "",
