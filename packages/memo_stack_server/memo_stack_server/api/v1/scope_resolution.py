...
from memo_stack_core.ports.auth import MemoryWriteScope, ReadScope

from memo_stack_server.auth_scope import canonical_scope_matches, resolve_existing_external_scope
