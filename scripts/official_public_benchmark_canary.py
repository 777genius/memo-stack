...
This script downloads official LoCoMo and LongMemEval datasets into a temporary
directory, runs the public benchmark runner, and emits one scorecard-compatible
report. It never stores benchmark datasets in the repository.
"""
